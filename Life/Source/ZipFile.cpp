...
ULONGLONG CZBaseFile::GetPosition() const
{
	return m_position;
}
...
ULONGLONG CZBaseFile::GetLength() const
{
	ASSERT(FALSE);
	return 0xFFFFFFFF;
}
...
ULONGLONG  CUncompressFile::GetPosition() const
{
	return CFile::GetPosition();
}

ULONGLONG  CUncompressFile::GetLength() const
{
